    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND {#tx_rcgprojectdb_domain_model_organization}.{#pid}=###CURRENT_PID### AND {#tx_rcgprojectdb_domain_model_organization}.{#sys_language_uid} IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
        ...
        'title' => [
            'exclude' => true,
            'label' => 'LLL:EXT:rcgprojectdb/Resources/Private/Language/locallang_db.xlf:tx_rcgprojectdb_domain_model_organization.title',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim',
        ...
        'logo' => [
            'exclude' => true,
            'label' => 'LLL:EXT:rcgprojectdb/Resources/Private/Language/locallang_db.xlf:tx_rcgprojectdb_domain_model_organization.logo',
            'config' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::getFileFieldTCAConfig(
                ...
                [
                    ...
                    'foreign_match_fields' => [
                        'fieldname' => 'logo',
                        'tablenames' => 'tx_rcgprojectdb_domain_model_organization',
        ...
        'url' => [
            'exclude' => true,
            'label' => 'LLL:EXT:rcgprojectdb/Resources/Private/Language/locallang_db.xlf:tx_rcgprojectdb_domain_model_organization.url',
            'config' => [
                'type' => 'input',
